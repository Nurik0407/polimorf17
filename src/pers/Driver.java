...
public class Driver extends Person {
    private double yearOfDriving;

    public Driver(long id, String fullName, byte age, char gender, String gmail, String phoneNumber, double governmentSalary, double yearOfDriving) {
    ...
    public void favoriteSport() {
        System.out.println(getFullName() + " favorite drifting");
    }


    @Override
    public String favoriteLanguage() {
        return getFullName() + " favorite  English";
    }

    public double getYearOfDriving() {
        return yearOfDriving;
    }

    public void setYearOfDriving(double yearOfDriving) {
        this.yearOfDriving = yearOfDriving;
    }
    ...
    public String drivingExperience() {
        return "Driving experience: " + (int) (getAge() - getYearOfDriving()) + " years";
    }
